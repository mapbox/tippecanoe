...
all: tippecanoe tippecanoe-enumerate tippecanoe-decode tile-join fuzz unit
...
tippecanoe: geojson.o jsonpull/jsonpull.o tile.o pool.o mbtiles.o geometry.o projection.o memfile.o clipper/clipper.o mvt.o serial.o main.o text.o polygon.o
...
fuzz: fuzz.o geometry.o projection.o polygon.o
