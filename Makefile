...
LDFLAGS := $(LDFLAGS)
WARNING_FLAGS := -Wall -Wshadow -Wsign-compare -Wextra -Wunreachable-code -Wuninitialized -Wshadow -Wbitfield-constant-conversion -Wbool-conversion -Wconstant-conversion -Wenum-conversion -Wliteral-conversion -Wnon-literal-null-conversion -Wnull-conversion -Wshorten-64-to-32 -Wstring-conversion -Wabsolute-value -Wfloat-conversion
